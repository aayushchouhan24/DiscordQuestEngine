...
settings_files=(
  ...
  "$HOME/Library/Application Support/discordptb/settings.json"
  "$HOME/Library/Application Support/discordcanary/settings.json"
)
...
echo "Restart Discord, then press Cmd + Option + I to open Developer Tools."